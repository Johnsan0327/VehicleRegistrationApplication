...
public class DemoApplication {
    ...
    @GetMapping("/read/{plateNumber}")
    public static String read(@PathVariable String plateNumber) {
    ...
    public static Boolean validate(String plateNumber) {
        ...
        Pattern q=Pattern.compile("^([a-zA-Z]{1,3}|([0-9]{1,3}))-[0-9]{4}");
        Matcher w= q.matcher(plateNumber);
